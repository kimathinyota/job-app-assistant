        ...
        >
            ...
            <div className="mb-3">
             ...
             <div className="mb-3">
                ...
                <textarea id="hobby-desc" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="e.g., Competitive chess player..." className="form-control" rows="3"/>
            </div>
